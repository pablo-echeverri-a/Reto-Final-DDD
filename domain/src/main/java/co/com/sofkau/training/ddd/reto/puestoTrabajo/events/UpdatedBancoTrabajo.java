...
public class UpdatedBancoTrabajo extends DomainEvent {
    private final BancoTrabajoId bancoTrabajoId;
    private final NumeroBanco numeroBanco;
    private final Sector sector;

    public UpdatedBancoTrabajo(BancoTrabajoId bancoTrabajoId, NumeroBanco numeroBanco, Sector sector){
        super("co.com.sofkau.training.ddd.reto.factura.events.UpdatedBancoTrabajo");
